...
public partial class Components : ComponentBase, IDisposable
{
    ...
    private ComponentDto? _pendingDelete;
    ...
    private async Task LoadAsync()
    {
        ...
        try
        {
            var result = await Api.Components.SearchAsync(_searchTerm, _pager.Page, _pager.PageSize);
    ...
    private void OnSearchInput(ChangeEventArgs e)
    {
        ...
        // Debounce: avoid firing a request per keystroke.
        _debounceTimer?.Stop();
    ...
    private void ConfirmDeleteAsync(ComponentDto item) => _pendingDelete = item;
    ...
    private async Task DeleteAsync()
    {
        ...
        try
        {
            await Api.Components.DeleteAsync(_pendingDelete.Id);
            _pendingDelete = null;
            await LoadAsync();
        }
        catch (Exception ex)
